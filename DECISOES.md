...
| **Consequência** | Esparsidade cai de 99,90% para ~99,0% — continua altíssima (realista), mas cada item agora tem dezenas de avaliadores. |
...
| **Consequência** | Distribuição de ratings observada fica realista: ~39% de notas 1–2, ~11% nota 3, ~50% notas 4–5 (antes eram ~90% de notas 4–5). A correlação entre relevância e popularidade cai para ~+0,11 — popularidade e preferência deixam de ser a mesma coisa. |
...
**Precision@10:** Aleatório 0,352 · Popularidade 0,785 · KNN 0,874 · **SVD 1,000**.
